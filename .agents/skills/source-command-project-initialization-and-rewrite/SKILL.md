---
name: "source-command-project-initialization-and-rewrite"
description: "Workflow command scaffold for project-initialization-and-rewrite in portfolio."
---

# source-command-project-initialization-and-rewrite

Use this skill when the user asks to run the migrated source command `project-initialization-and-rewrite`.
