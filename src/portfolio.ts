...
const socialMediaLinks = {
  ...
  gmail: "mailto:lasse.siemoneit@gmail.com",
  instagram: "https://www.instagram.com/lsiem092",
} as const;
      ...
      categories: [
        ...
        },
        {
          ...
          softwareSkills: [
            ...
            {
              skillName: "OWASP ZAP",
              fontAwesomeClassname: "simple-icons:owaspzap",
              style: {
                color: "#3776AB",
              },
            },
            {
              skillName: "Nessus",
              fontAwesomeClassname: "simple-icons:nessus",
              style: {
                color: "#3776AB",
              },
            },
      ...
      categories: [
        {
          ...
          softwareSkills: [
            {
              skillName: "IT-Infrastruktur",
              fontAwesomeClassname: "simple-icons:instructure",
              style: {
                color: "#3776AB",
              },
            },
            {
              skillName: "Digitale Transformation",
        ...
        },
        {
          ...
          softwareSkills: [
            {
              skillName: "Sicherheitsstrategien",
            ...
            },
            {
              ...
              fontAwesomeClassname: "fa-solid:balance-scale",
              style: {
                color: "#3776AB",
              },
            },
            {
              skillName: "Informationssicherheit",
